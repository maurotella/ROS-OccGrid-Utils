...
def get_map_img(map_data:list, size:tuple, crop=False, padding=30):
    ...
    size: tuple[int, int]
        Tuple containing the height and the width of the map
    cut: bool
...
def plot_map_img(img:list, ax:Axes, bg_color="#607372") -> None:
    ...
    bg_color: str
        Color of the unscanned cells (-1) pf the map; the format is the
...
if __name__=='__main__':
    plot_map_img(get_map_img(MAPS['marty']),plt.gca())